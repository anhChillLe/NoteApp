...
type ComponentWithRef<T extends Component, P> = ForwardRefExoticComponent<
  PropsWithoutRef<P> & { ref: Ref<T> | AnimatedRef<T> }
>
...
function createDetectGestureItem<P>(
  ...
  function DetectedGestureItem<T>({
    ...
    const { position, target, setExtras } = useDrag<T>()
    ...
    }, [ref.current, onActiveDrag, onInactiveDrag, setExtras])
